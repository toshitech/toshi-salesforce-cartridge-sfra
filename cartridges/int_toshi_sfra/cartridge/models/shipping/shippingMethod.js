...
function ShippingMethodModel(shippingMethod, shipment) {
    ...
    this.toshiAvailabilityCheck = shippingMethod.custom.toshiMethod.value ? shippingMethod.custom.toshiMethod.value : null;
    this.toshiKey = shippingMethod.custom.toshiMethod.value && session.privacy.toshiKey ? session.privacy.toshiKey :null;
